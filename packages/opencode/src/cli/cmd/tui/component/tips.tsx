...
const TIPS = [
  ...
  "Press {highlight}Tab{/highlight} to cycle through primary agents (pair, socratic, vibe, claw, adaptive)",
  ...
  "Switch to {highlight}Pair{/highlight} agent to get suggestions without making actual changes",
