    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinat1/humancode"),
            text: "HumanCode Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinat1/humancode/discussions"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinat1/humancode/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/devinat1/humancode/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
